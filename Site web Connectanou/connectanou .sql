...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 13 sep. 2019 à 11:14
...
(1, 'Informatique - Réseau - Télécom - Audiovisuel - Graphisme', NULL),
...
CREATE TABLE IF NOT EXISTS `ecole` (
  ...
  `adresse_ecole` text NOT NULL,
  `tel_ecole` int(11) NOT NULL,
  `email_ecole` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `organisation` (
  ...
  `nombre_salarie` int(11) NOT NULL,
  `site_internet_orga` text NOT NULL,
  `adresse_orga` text NOT NULL,
  `idCp` int(11) NOT NULL,
  `idType_orga` int(11) NOT NULL,
  `idPorteur` int(11) NOT NULL,
  PRIMARY KEY (`id_orga`),
  KEY `id_cp` (`idCp`),
  KEY `idtype_orga` (`idType_orga`),
  KEY `IdPorteur` (`idPorteur`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `ecole`
  ADD CONSTRAINT `ecole_ibfk_2` FOREIGN KEY (`id_ecole`) REFERENCES `realisateur` (`id_real`),
...
ALTER TABLE `organisation`
  ADD CONSTRAINT `organisation_ibfk_1` FOREIGN KEY (`idCp`) REFERENCES `code_postal` (`id_cp`),
  ADD CONSTRAINT `organisation_ibfk_2` FOREIGN KEY (`idType_orga`) REFERENCES `type_organisation` (`id_type_org`),
  ADD CONSTRAINT `organisation_ibfk_3` FOREIGN KEY (`idPorteur`) REFERENCES `porteur` (`idPorteur`);

--
-- Contraintes pour la table `porteur`
--
ALTER TABLE `porteur`
  ADD CONSTRAINT `porteur_ibfk_1` FOREIGN KEY (`idOrg`) REFERENCES `organisation` (`id_orga`),
  ADD CONSTRAINT `porteur_ibfk_2` FOREIGN KEY (`idCp`) REFERENCES `code_postal` (`id_cp`);

--
-- Contraintes pour la table `projet`
--
ALTER TABLE `projet`
  ADD CONSTRAINT `projet_ibfk_1` FOREIGN KEY (`id_porteur`) REFERENCES `porteur` (`idPorteur`),
