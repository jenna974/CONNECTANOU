<section class="mt-5 mb-5 changeFont">
  <div class="container-fluid text-center">    
    <div class="row ">
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  mt-5"> <br><br>
  
        <h1>Bienvenue sur Connectanou.re</h1><br><br>
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/slide2.png" class="d-block w-100" alt="photo">
            </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mt-5 mb-5"><br><br>
